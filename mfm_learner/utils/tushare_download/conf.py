...
INTERVAL_STEP = 5  # 单位毫秒，2次API调用间的间隔，异常后会倍数递增：https://tushare.pro/document/1?doc_id=290 ,每分钟可以访问多少次，200元/年的账号默认是400/分钟，但是大量访问会降级到200/分钟，所以可能要经常手工调整，为了提取，设置成300次/分钟
SLEEP_INTERVAL = 60 # 下载发生异常等待retry的时间
