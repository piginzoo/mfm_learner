"""
参考：
- https://finance.sina.com.cn/money/smjj/smdt/2021-07-06/doc-ikqciyzk3908181.shtml
- https://mp.weixin.qq.com/s/WTu6sI7ZkXTtSuC_CdwsGg
"""
...
CLVneutralizedfactor_stk = CLVneutralizedfactor_stk.rename_axis(
    columns=None)  # 行变列，参考：https://www.cnblogs.com/traditional/p/11967360.html
...
for date in excess_returns_means.index:
    ...
    for i in range(n_quantile):
        ...
        i_quantile_index = factor_CLV[
            (factor_CLV <= clv_factor_up) & (factor_CLV > clv_factor_down)].index  # 在clv中找到对应分位数的股票代码
